...
<ul>
  <li><a id="man_events" href="adminpage_view.php"><span>Manage Users</span></a></li>
</ul>
<br><br>
 </div>
...
<?php
$result = mysqli_query($mysqli,"SELECT * FROM event, user WHERE user_id = manager_id AND event >= cast((now()) as date) AND approved='1' ORDER BY event");
